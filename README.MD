...
URL: 
```
http://127.0.0.1:8082/v1/route?coordinates=-96.7533417,32.9950066,-96.7504163,32.9862204
```
...
```
Note that the code is an Enum type: 1-success, 0-failed. The following is a fialed example:
```
{
    "code": 0,
